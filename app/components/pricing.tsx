...
const tiers = [
  {
    name: "Launch Special",
    price: "150",
    description: "Reach 10K Followers in Just Three Month's or Pay Nothing!",
    features: [
      "Manage social media", "Get social media to 10k+ Followers",
       "+Bonus: Website+hosting+domain", 
       "+Bonus: 15 min weekly call with marketing professional", 
