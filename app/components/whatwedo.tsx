  ...
  return (
    <div className='pt-80 mt-10 text-center'>
        ...
        <div className='flex items-center justify-center'>
            <Separator className='mb-2 bg-slate-100/20 h-1 w-80' data-aos='fade-down'/>
        </div>
        <div className="max-w-sm mx-auto bg-gray-800 text-gray-200 rounded-lg shadow-md p-6 mt-5 border border-gray-200" data-aos='fade-down'>
            ...
            <ul className="space-y-3 mb-5 font-semibold">
                ...
                <Check
                              ...
                              aria-hidden="true"
                            />
                    We help restaurants in USA grow their social media.
                </li>
                <li className=" mb-5 flex items-start ">
                <Check
                              className={cn("h-6 w-5 flex-none", {"text-emerald-400": true})}
                              aria-hidden="true"
                            />
                    Guaranteed Growth: Pay nothing until we reach 10,000 followers in the first 3 month. After that, continue to receive premium services designed for unmatched value.
                </li>
                <li className=" mb-5 flex items-start ">
                <Check
                              className={cn("h-6 w-5 flex-none", {"text-emerald-400": true})}
                              aria-hidden="true"
                            />
                    Full-Service Social Media Management: We create and manage your social media accounts, crafting tailored content to engage and grow your audience.
                </li>
            </ul>
