...
const faqData: FAQCategory = {
  "General Questions": [
    ...
    },
    {
      ...
      answer: "Our guarantee promises that if we do not increase your followers to 1k within the first month of service, you pay nothing. This offer is applicable to all our initial service sign-ups.",
    },
  ],
  "Pricing": [
    {
      question: "What does the $129/month subscription include?",
      answer: (
        <>
          <p className="mb-4">Our $129/month subscription provides comprehensive social media management to amplify your online presence. This plan includes:</p>
          ...
          <p className="mb-4">As a special offer for our first <strong> 5 clients</strong>, we also include additional bonuses valued at <strong>$200</strong>:</p>
          <ul className="list-inside list-disc space-y-2">
    ...
    },
    {
      ...
      answer: "Initial pricing is discounted to welcome our first clients and to build our portfolio. The regular pricing reflects the extensive effort and resources we invest in managing and growing your social media presence effectively.",
    },
  ],
